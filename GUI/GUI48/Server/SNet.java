...
class AnimationBall {
	...
	private Bounds boundsRec;
	
	private int i = 0;
	private int[] playerID;
	private int playerIDnow;
...
class Thread_Clients_Connection extends Thread {
	...
	private Server[] s = new Server[4];
	private int i = 0;
	private CoordXY cr = new CoordXY();
...
class Server extends Thread
{
	...
	private AnimationBall ab;
	private int playerID;
	private int playerIDclient;
	private int countPlayers;
	
	private double recX, recY = 0;
	private double otherX, otherY = 0;
